...
const WorksCard = ({work}) => {
  ...
  return (
    <div className='flex flex-col items-center glass w-84 min-h-64 py-6 px-6 gap-6'>
      ...
      <Image src={logo} className='w-auto h-24' width={400} height={400} alt='Imagen'/>

      <div className='flex flex-col items-center'>
        <p className="text-slate-100 text-2xl font-bold">{nombre}</p>
        <p className='text-slate-100 text-xl mb-4'>{concepto}</p>
